...
#   pragma message( \
  ...
  "- addDP -D_WIN32_WINNT=0x0501 to the compiler command line; or\n"\
  "- addDP _WIN32_WINNT=0x0501 to your project's Preprocessor Definitions.\n"\
  "Assuming _WIN32_WINNT=0x0501 (i.e. Windows XP target).")
#  else // defined(_MSC_VER) || defined(__BORLANDC__)
#   warning Please define _WIN32_WINNT or _WIN32_WINDOWS appropriately.
#   warning For example, addDP -D_WIN32_WINNT=0x0501 to the compiler command line.
