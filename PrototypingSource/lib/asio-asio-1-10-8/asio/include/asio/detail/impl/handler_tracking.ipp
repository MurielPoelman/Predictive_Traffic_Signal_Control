...
void handler_tracking::write_line(const char* format, ...)
{
  ...
  int length_ = vsprintf_s(line, sizeof(line), format, args);
#else // defined(ASIO_HAS_SECURE_RTL)
  int length_ = vsprintf(line, format, args);
  ...
  ::WriteFile(stderr_handle, line, length_, &bytes_written, 0);
#else // defined(ASIO_WINDOWS)
  ::write(STDERR_FILENO, line, length_);
#endif // defined(ASIO_WINDOWS)
}
